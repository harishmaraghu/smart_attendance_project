...
class TopDashboardinprofilelocation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container  (
      ...
      decoration: BoxDecoration(
        color: colors.leave_dashboard_card_1_color,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(width: 12),
              Text('Loaction',style: AppTextstyle.heading_text.copyWith(
                fontSize: 18,
              ),
              ),
            ],
